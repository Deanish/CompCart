...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from psu where name='Seasonic SS400BT PSU'");
	...
	$query = mysql_query("SELECT * from hd where name='Toshiba 500 GB'");
	...
	$query = mysql_query("SELECT * from cab where name='Cooler Master Elite 431 Plus'");
	...
	$query = mysql_query("SELECT * from mon where name='Dell E1913S 19 inch LED'");
