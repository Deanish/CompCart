...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from ram where name='Kingston DDR3 8 GB'");
	...
	$query = mysql_query("SELECT * from gp where name='Asus NVIDIA GTX 680 2 GB GDDR5'");
	...
	$query = mysql_query("SELECT * from hd where name='Seagate Constellation ES 2 TB'");
	...
	$query = mysql_query("SELECT * from sp where name='JBL Harman Kardon Go Micro'");
	...
	$query = mysql_query("SELECT * from ms where name='Dell WM311 Wireless'");
