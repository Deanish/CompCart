...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Cabinets</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $cabimg . "' target='_blank'><img src='img/img/" . $cabimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $cabname . "<input type='text' id='txt' name='txt' value='" . $cabname . "' style='display:none' /></th>
			  <th>" . $cabd1 . "<br />" . $cabd2 . "<br />" . $cabd3 . "<br />" . $cabd4 . "<br />" . $cabd5 . "<br /></th>
			  <th>" . $cabm . "</th>
			  <th>" . $cabd . "%</th>
			  <th>" . $cabt . "<input type='text' id='amt' name='amt' value='" . $cabt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='cab' name='cab' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $cabname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $cabt . "' style='width:50px; display:none' />
