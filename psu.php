...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Power Supply Units</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $psuimg . "' target='_blank'><img src='img/img/" . $psuimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $psuname . "<input type='text' id='txt' name='txt' value='" . $psuname . "' style='display:none' /></th>
			  <th>" . $psud1 . "<br />" . $psud2 . "<br />" . $psud3 . "<br />" . $psud4 . "<br />" . $psud5 . "<br /></th>
			  <th>" . $psum . "</th>
			  <th>" . $psud . "%</th>
			  <th>" . $psut . "<input type='text' id='amt' name='amt' value='" . $psut . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='psu' name='psu' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $psuname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $psut . "' style='width:50px; display:none' />
