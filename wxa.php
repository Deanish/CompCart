...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Antivirus supported by Windows XP</h1><hr />
<?php 
	...
	$query = mysql_query("SELECT * from wxa");
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Name</th><th>Image</th><th>RAM required</th><th>MRP</th><th>&nbsp</th><th></th></tr>";
