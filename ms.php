...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Mouse</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $msimg . "' target='_blank'><img src='img/img/" . $msimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $msname . "<input type='text' id='txt' name='txt' value='" . $msname . "' style='display:none' /></th>
			  <th>" . $msd1 . "<br />" . $msd2 . "<br />" . $msd3 . "<br />" . $msd4 . "<br />" . $msd5 . "<br /></th>
			  <th>" . $msm . "</th>
			  <th>" . $msd . "%</th>
			  <th>" . $mst . "<input type='text' id='amt' name='amt' value='" . $mst . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='ms' name='ms' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $msname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $mst . "' style='width:50px; display:none' />
