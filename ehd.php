...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp External Hard Disks</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $ehdimg . "' target='_blank'><img src='img/img/" . $ehdimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $ehdname . "<input type='text' id='txt' name='txt' value='" . $ehdname . "' style='display:none' /></th>
			  <th>" . $ehdd1 . "<br />" . $ehdd2 . "<br />" . $ehdd3 . "<br />" . $ehdd4 . "<br />" . $ehdd5 . "<br /></th>
			  <th>" . $ehdm . "</th>
			  <th>" . $ehdd . "%</th>
			  <th>" . $ehdt . "<input type='text' id='amt' name='amt' value='" . $ehdt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='ehd' name='ehd' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $ehdname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $ehdt . "' style='width:50px; display:none' />
