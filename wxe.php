...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Education softwares supported by Windows XP</h1><hr />
<?php 
	...
	$query = mysql_query("SELECT * from wxe");
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Name</th><th>Image</th><th>Recommended Processor</th><th>RAM required</th><th>Hard disk required</th><th>MRP</th><th>&nbsp</th><th></th></tr>";
