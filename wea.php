...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Anti virus supported by Windows8</h1><hr />
<?php 
	...
	$query = mysql_query("SELECT * from wea");
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Name</th><th>Image</th><th>Hard disk required</th><th>MRP</th><th>&nbsp</th><th></th></tr>";
