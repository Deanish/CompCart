...
<?php 
	...
	$query = mysql_query("SELECT * from lram");
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Image</th><th>Name</th><th>Description</th><th>MRP</th><th>Discount</th><th>Total</th><th>&nbsp</th></tr>";
	...
	echo "
			...
			<tr><th><a href='img/img/" . $ramimg . "' target='_blank'><img src='img/img/" . $ramimg . "' width='100px' height='100px' /></a></th>
			  ...
			  <th><input type='submit' value='BUY' id='ram' name='ram' /></th></tr>
			  </form>";
	}
 	echo "</table>";
