...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Keyboards</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $kbimg . "' target='_blank'><img src='img/img/" . $kbimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $kbname . "<input type='text' id='txt' name='txt' value='" . $kbname . "' style='display:none' /></th>
			  <th>" . $kbd1 . "<br />" . $kbd2 . "<br />" . $kbd3 . "<br />" . $kbd4 . "<br />" . $kbd5 . "<br /></th>
			  <th>" . $kbm . "</th>
			  <th>" . $kbd . "%</th>
			  <th>" . $kbt . "<input type='text' id='amt' name='amt' value='" . $kbt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='kb' name='kb' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $kbname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $kbt . "' style='width:50px; display:none' />
