...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Coolers</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $clsimg . "' target='_blank'><img src='img/img/" . $clsimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $clsname . "<input type='text' id='txt' name='txt' value='" . $clsname . "' style='display:none' /></th>
			  <th>" . $clsd1 . "<br />" . $clsd2 . "<br />" . $clsd3 . "<br />" . $clsd4 . "<br />" . $clsd5 . "<br /></th>
			  <th>" . $clsm . "</th>
			  <th>" . $clsd . "%</th>
			  <th>" . $clst . "<input type='text' id='amt' name='amt' value='" . $clst . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='cls' name='cls' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $clsname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $clst . "' style='width:50px; display:none' />
