...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Graphics Cards</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $gpsimg . "' target='_blank'><img src='img/img/" . $gpsimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $gpsname . "<input type='text' id='txt' name='txt' value='" . $gpsname . "' style='display:none' /></th>
			  <th>" . $gpsd1 . "<br />" . $gpsd2 . "<br />" . $gpsd3 . "<br />" . $gpsd4 . "<br />" . $gpsd5 . "<br /></th>
			  <th>" . $gpsm . "</th>
			  <th>" . $gpsd . "%</th>
			  <th>" . $gpst . "<input type='text' id='amt' name='amt' value='" . $gpst . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='gps' name='gps' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $gpsname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $gpst . "' style='width:50px; display:none' />
