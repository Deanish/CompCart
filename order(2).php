...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<tr><th width="30%" align="right">Product Name :</th><th><input type="text" name="prd1" value="<?php echo $_GET['txt']; ?>" disabled /><input type="text" name="prd" value="<?php echo $_GET['txt']; ?>" style="display:none" /></th></tr>
