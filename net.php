...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Network Components</h1>
	<hr />
	<table border="0" id="t1" align="center" font-size="20px" style="left: 200px; top: 540px;" width="90%">
	<tr><th>
		<a href="cable.php" >
	      <img src=" img/examples/cable.jpg" alt="" width="200" height="300"><br />
		  Cables
	    </a>
	</th><th>
		<a href="swt.php" >
	      <img src=" img/examples/swt.jpg" alt="" width="200" height="300"><br />
		  Switch
	    </a>
	</th><th>
		<a href="wire.php" >
	      <img src=" img/examples/wire.jpg" alt="" width="200" height="300"><br />
		  Wireless USB
	    </a>
	</th></tr><tr><th>
		<a href="modo.php" >
	      <img src=" img/examples/mod.jpg" alt="" width="200" height="300"><br />
		  MODEM
	    </a>
	</th><th>
		<a href="ic.php" >
	      <img src=" img/examples/ic.jpg" alt="" width="200" height="300"><br />
		  Interface Cards
	    </a>
	</th><th>
		<a href="router.php" >
	      <img src=" img/examples/router.jpg" alt="" width="200" height="300"><br />
		  Routers
	    </a>
	</th>
	</tr>
