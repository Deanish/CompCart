...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Printers</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $prtimg . "' target='_blank'><img src='img/img/" . $prtimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $prtname . "<input type='text' id='txt' name='txt' value='" . $prtname . "' style='display:none' /></th>
			  <th>" . $prtd1 . "<br />" . $prtd2 . "<br />" . $prtd3 . "<br />" . $prtd4 . "<br />" . $prtd5 . "<br /></th>
			  <th>" . $prtm . "</th>
			  <th>" . $prtd . "%</th>
			  <th>" . $prtt . "<input type='text' id='amt' name='amt' value='" . $prtt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='ptr' name='ptr' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $prtname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $prtt . "' style='width:50px; display:none' />
