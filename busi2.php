...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<tr><th width="15%" align="left">MRP:</th><th>188066</th><th>230304</th><th>165958</th></tr>
	<tr><th width="15%" align="left">Discount:</th><th>25%</th><th>12%</th><th>5%</th></tr>
	<tr><th width="15%" align="left">Total:</th><th>150452</th><th>202667</th><th>157660</th></tr>
	<tr><th width="15%"align="left"></th>
		<th><form name='form2' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Business 7' style='display:none' />
			  <input type='text' id='amt' name='amt' value='150452' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  <a href="pbu5.php" target="_blank">Preview</a></form></th>
		   <th><form name='form1' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Business 8' style='display:none' />
			  <input type='text' id='amt' name='amt' value='202667' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  <a href="pbu6.php" target="_blank">Preview</a></form></th>
			  <th><form name='form3' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Business 9' style='display:none' />
			  <input type='text' id='amt' name='amt' value='157660' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  <a href="pbu7.php" target="_blank">Preview</a></form></th>
			  </tr>
	</table>
