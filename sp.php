...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Speakers</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $spimg . "' target='_blank'><img src='img/img/" . $spimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $spname . "<input type='text' id='txt' name='txt' value='" . $spname . "' style='display:none' /></th>
			  <th>" . $spd1 . "<br />" . $spd2 . "<br />" . $spd3 . "<br />" . $spd4 . "<br />" . $spd5 . "<br /></th>
			  <th>" . $spm . "</th>
			  <th>" . $spd . "%</th>
			  <th>" . $spt . "<input type='text' id='amt' name='amt' value='" . $spt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='sp' name='sp' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $spname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $spt . "' style='width:50px; display:none' />
