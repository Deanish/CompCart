...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<tr><th width="15%" align="left">MRP:</th><th>37219</th><th>47137</th><th>46433</th></tr>
	<tr><th width="15%" align="left">Discount:</th><th>5%</th><th>12%</th><th>5%</th></tr>
	<tr><th width="15%" align="left">Total:</th><th>35359</th><th>41481</th><th>44112</th></tr>
	<tr><th width="15%"align="left"></th>
		<th><form name='form2' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Personal 4' style='display:none' />
			  <input type='text' id='amt' name='amt' value='35359' style='width:50px; display:none' />
		   ...
		   <th><form name='form1' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Personal 5' style='display:none' />
			  <input type='text' id='amt' name='amt' value='41481' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  ...
			  <input type='text' id='amt' name='amt' value='44112' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
