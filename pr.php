...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Processors</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $primg . "' target='_blank'><img src='img/img/" . $primg . "' width='100px' height='100px' /></a></th>
			  <th>" . $prname . "<input type='text' id='txt' name='txt' value='" . $prname . "' style='display:none' /></th>
			  <th>" . $prd1 . "<br />" . $prd2 . "<br />" . $prd3 . "<br />" . $prd4 . "<br />" . $prd5 . "<br /></th>
			  <th>" . $prm . "</th>
			  <th>" . $prd . "%</th>
			  <th>" . $prt . "<input type='text' id='amt' name='amt' value='" . $prt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='pr' name='pr' /></th>
			  </form>
			  
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $prname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $prt . "' style='width:50px; display:none' />
