...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<tr><th width="15%" align="left">MRP:</th><th>61739</th><th>55927</th><th>80554</th></tr>
	<tr><th width="15%" align="left">Discount:</th><th>5%</th><th>6%</th><th>5%</th></tr>
	<tr><th width="15%" align="left">Total:</th><th>58652</th><th>52571</th><th>76526</th></tr>
	<tr><th width="15%"align="left"></th>
		<th><form name='form2' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Business 4' style='display:none' />
			  <input type='text' id='amt' name='amt' value='58652' style='width:50px; display:none' />
		   ...
		   <th><form name='form1' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Business 5' style='display:none' />
			  <input type='text' id='amt' name='amt' value='52571' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  ...
			  <input type='text' id='amt' name='amt' value='76526' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
