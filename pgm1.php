...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from mb where name='Intel DX79TO Motherboard'");
	...
	$query = mysql_query("SELECT * from psu where name='Seasonic M12II-650 650 Watts PSU'");
	...
	$query = mysql_query("SELECT * from mon where name='Dell S2240L 21.5 inch LED'");
