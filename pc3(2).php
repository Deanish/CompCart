...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from mb where name='Intel DH77EB Motherboard'");
	...
	$query = mysql_query("SELECT * from cab where name='Cooler Master HAF 912'");
	...
	$query = mysql_query("SELECT * from mon where name='HP Pavilion 20FI 20 inch LED'");
	...
	$query = mysql_query("SELECT * from sp where name='Creative SBS A335 2.1'");
