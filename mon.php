...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Monitors</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $monimg . "' target='_blank'><img src='img/img/" . $monimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $monname . "<input type='text' id='txt' name='txt' value='" . $monname . "' style='display:none' /></th>
			  <th>" . $mond1 . "<br />" . $mond2 . "<br />" . $mond3 . "<br />" . $mond4 . "<br />" . $mond5 . "<br /></th>
			  <th>" . $monm . "</th>
			  <th>" . $mond . "%</th>
			  <th>" . $mont . "<input type='text' id='amt' name='amt' value='" . $mont . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='mon' name='mon' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $monname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $mont . "' style='width:50px; display:none' />
