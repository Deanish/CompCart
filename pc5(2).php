...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from pr where name='AMD 3.9 GHz FM2 Quad-Core A8-6600K APU Processor'");
	...
	$query = mysql_query("SELECT * from ram where name='Kingston DDR2 2 GB'");
	...
	$query = mysql_query("SELECT * from gp where name='Forsa NVIDIA GT630 4 GB SDDR3'");
	...
	$query = mysql_query("SELECT * from psu where name='Corsair CX430M 430 Watts'");
	...
	$query = mysql_query("SELECT * from kb where name='Dell 104 Quiet Key'");
	...
	$query = mysql_query("SELECT * from sp where name='iBall Tarang 4.1'");
	...
	$query = mysql_query("SELECT * from ptr where name='Canon PIXMA - MP 287'");
