...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<tr><th width="15%" align="left">MRP:</th><th>37125</th><th>38021</th><th>44806</th></tr>
	<tr><th width="15%" align="left">Discount:</th><th>5%</th><th>12%</th><th>10%</th></tr>
	<tr><th width="15%" align="left">Total:</th><th>35269</th><th>33459</th><th>40326</th></tr>
	<tr><th width="15%"align="left"></th>
		<th><form name='form2' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Gaming 4' style='display:none' />
			  <input type='text' id='amt' name='amt' value='35269' style='width:50px; display:none' />
		   ...
		   <th><form name='form1' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Gaming 5' style='display:none' />
			  <input type='text' id='amt' name='amt' value='33459' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  ...
			  <input type='text' id='amt' name='amt' value='40326' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
