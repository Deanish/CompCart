...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Multimedia supported by Windows XP</h1><hr />
<?php 
	...
	$query = mysql_query("SELECT * from wxm");
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Name</th><th>Image</th><th>Recommended Processor</th><th>RAM required</th><th>MRP</th><th>&nbsp</th><th></th></tr>";
