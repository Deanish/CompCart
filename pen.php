...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Pendrives</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $penimg . "' target='_blank'><img src='img/img/" . $penimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $penname . "<input type='text' id='txt' name='txt' value='" . $penname . "' style='display:none' /></th>
			  <th>" . $pend1 . "<br />" . $pend2 . "<br />" . $pend3 . "<br />" . $pend4 . "<br />" . $pend5 . "<br /></th>
			  <th>" . $penm . "</th>
			  <th>" . $pend . "%</th>
			  <th>" . $pent . "<input type='text' id='amt' name='amt' value='" . $pent . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='pen' name='pen' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $penname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $pent . "' style='width:50px; display:none' />
