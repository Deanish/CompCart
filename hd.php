...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Hard Drives</h1><hr />
<?php 
	...
	echo "
			...
			<tr><th><a href='img/img/" . $hdimg . "' target='_blank'><img src='img/img/" . $hdimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $hdname . "<input type='text' id='txt' name='txt' value='" . $hdname . "' style='display:none' /></th>
			  <th>" . $hdd1 . "<br />" . $hdd2 . "<br />" . $hdd3 . "<br />" . $hdd4 . "<br />" . $hdd5 . "<br /></th>
			  <th>" . $hdm . "</th>
			  <th>" . $hdd . "%</th>
			  <th>" . $hdt . "<input type='text' id='amt' name='amt' value='" . $hdt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='hd' name='hd' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $hdname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $hdt . "' style='width:50px; display:none' />
