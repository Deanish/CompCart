...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	echo "<table border='1' align='center' font-size='20px' width='95%' >
			...
			<th>Speaker</th><th>Cabinet</th><th>Monitor</th><th>Printer</th><th>Price</th><th>Confirmed</th><th>Rejected</th></tr>";
	while($row = mysql_fetch_array($query))
	{
	
	echo "
			<form name='form1' action='custc.php' method='get'>
			<tr><th>" . $row['cid'] . "<input type='text' name='txt' value='" . $row['cid'] . "' style='display:none' /></th>
			  ...
			  <form name='form2' action='custr.php' method='get'>
