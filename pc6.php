...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from mb where name='ASUS P8B75-M LX Motherboard'");
	...
	$query = mysql_query("SELECT * from pr where name='AMD 3.3 GHz AM3 FX6100 Processor'");
	...
	$query = mysql_query("SELECT * from ram where name='Transcend DDR2 2 GB'");
	...
	$query = mysql_query("SELECT * from gp where name='Forsa NVIDIA GeForce GTS 450 4 GB SDDR3'");
	...
	$query = mysql_query("SELECT * from psu where name='Zebronic Zeb 450W'");
	...
	$query = mysql_query("SELECT * from cab where name='Cooler Master HAF 912 Combat'");
	...
	$query = mysql_query("SELECT * from sp where name='Creative Inspire M4500 4.1'");
	...
	$query = mysql_query("SELECT * from ptr where name='Canon PIXMA MG2270'");
