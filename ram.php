...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp RAMs</h1><hr />
<?php 
	...
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Image</th><th>Name</th><th>Description</th><th>MRP</th><th>Discount</th><th>Total</th><th>&nbsp</th><th>&nbsp</th></tr>";
	...
	echo "
			...
			<tr><th><a href='img/img/" . $ramimg . "' target='_blank'><img src='img/img/" . $ramimg . "' width='100px' height='100px' /></a></th>
			  <th>" . $ramname . "<input type='text' id='txt' name='txt' value='" . $ramname . "' style='display:none' /></th>
			  <th>" . $ramd1 . "<br />" . $ramd2 . "<br />" . $ramd3 . "<br />" . $ramd4 . "<br />" . $ramd5 . "<br /></th>
			  <th>" . $ramm . "</th>
			  <th>" . $ramd . "%</th>
			  <th>" . $ramt . "<input type='text' id='amt' name='amt' value='" . $ramt . "' style='width:50px; display:none' /></th>
			  <th><input type='submit' value='BUY' id='ram' name='ram' /></th>
			  </form>
			  <form name='form2' action='review.php' method='get'>
			  <th>
			  <input type='text' id='txt' name='txt' value='" . $ramname . "' style='display:none' />
			  <input type='text' id='amt' name='amt' value='" . $ramt . "' style='width:50px; display:none' />
