...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Software components</h1>
	<hr />
	<table border="0" id="t1" align="center" font-size="20px" style="left: 200px; top: 540px;" width="90%">
	<tr><th>
		<a href="windows7.php" >
	      <img src=" img/examples/windows7.jpg" alt="" width="200" height="500"><br />
		  Windows 7
	    </a>
	</th><th>
		<a href="windows8.php" >
	      <img src=" img/examples/windows8.jpg" alt="" width="200" height="500"><br />
		  Windows 8
	    </a>
	</th><th>
		<a href="windowsxp.php" >
	      <img src=" img/examples/windowsxp.jpg" alt="" width="200" height="500"><br />
		  Windows XP
	    </a>
	</th></tr>
	<tr><th>
		<a href="ubuntu.php" >
	      <img src=" img/examples/ubuntu.jpg" alt="" width="200" height="500"><br />
		  Ubuntu
	    </a>
	</th><th>
		<a href="mac.php" >
	      <img src=" img/examples/Mac.jpg" alt="" width="200" height="500"><br />
		  MAC
	    </a>
	</th></tr>
