...
<html lang="en">
  ...
  <body onload="startTime();">
	...
	$query = mysql_query("SELECT * from ram where name='Corsair Vengeance DDR3 8 GB'");
	...
	$query = mysql_query("SELECT * from gp where name='Asus AMD/ATI HD 7970 3 GB GDDR5'");
	...
	$query = mysql_query("SELECT * from psu where name='Cooler Master Vanguard 1000 Watts'");
	...
	$query = mysql_query("SELECT * from sp where name='Klipsch Gallery G-17 Wireless Airplay'");
	...
	$query = mysql_query("SELECT * from kb where name='Roccat ISKU FX'");
	...
	$query = mysql_query("SELECT * from cab where name='Cooler Master Trooper'");
