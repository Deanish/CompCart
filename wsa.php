...
<head>
  ...
  <body onload="startTime();">
	...
	<h1>&nbsp&nbsp&nbsp&nbsp Antivirus supported by Windows7</h1><hr />
<?php 
	...
	$query = mysql_query("SELECT * from wsa");
	echo "<table border='1' align='center' font-size='20px' width='80%' >
			<tr><th>Name</th><th>Image</th><th>Harddrive required</th><th>MRP</th><th>&nbsp</th><th>&nbsp</th></tr>";
	...
	echo "
			...
			<tr><th>" . $mbname . "<input type='text' id='txt' name='txt' value='" . $mbname . "' style='display:none' /></th>
			<th><a href='img/img/" . $mbimg . "' target='_blank'><img src='img/img/" . $mbimg . "' width='100px' height='100px' /></a></th>
			<th>" . $mbhdd . "</th>
			<th>" . $mbd1 . "<input type='text' id='amt' name='amt' value='" . $mbd1 . "' style='width:50px; display:none' /></th>
