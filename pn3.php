...
function startTime()
{
  ...
  <body onload="startTime();">
	...
	<tr><th width="15%" align="left">Printer:</th><th>HP Deskjet 1510</th><th>Canon PIXMA - MP 287</th><th>Canon PIXMA MG2270</th></tr>
	<tr><th width="15%" align="left">MRP:</th><th>67100</th><th>74850</th><th>90180</th></tr>
	<tr><th width="15%" align="left">Discount:</th><th>6%</th><th>8%</th><th>10%</th></tr>
	<tr><th width="15%" align="left">Total:</th><th>63078</th><th>68862</th><th>81162</th></tr>
	<tr><th width="15%"align="left"></th>
		<th><form name='form2' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Personal 4' style='display:none' />
			  <input type='text' id='amt' name='amt' value='63078' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  <a href="pc4.php" target="_blank">Preview</a></form></th>
		   <th><form name='form1' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Personal 5' style='display:none' />
			  <input type='text' id='amt' name='amt' value='68862' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  <a href="pc5.php" target="_blank">Preview</a></form></th>
			  <th><form name='form3' action='order.php' method='get'><input type='text' id='txt' name='txt' value='Personal 6' style='display:none' />
			  <input type='text' id='amt' name='amt' value='81162' style='width:50px; display:none' />
			  <input type='submit' value='Buy' id='mb' name='mb' />
			  <a href="pc6.php" target="_blank">Preview</a></form></th>
			  </tr>
	</table>
